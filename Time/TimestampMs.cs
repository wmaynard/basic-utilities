...
public static class TimestampMs
{
    ...
    public static long InThePast(int seconds = 0, int minutes = 0, int hours = 0, int days = 0, int weeks = 0, int months = 0, int years = 0)
        => DateTimeOffset.UtcNow
            ...
            .ToUnixTimeMilliseconds();
    public static DateTime ToDateTime(this long unixTimestamp) => DateTimeOffset.FromUnixTimeMilliseconds(unixTimestamp).DateTime;
    public static DateTime ToDateTimeUtc(this long unixTimestamp) => DateTimeOffset.FromUnixTimeMilliseconds(unixTimestamp).UtcDateTime;
}